...
theme_set_dark() {
  local _left_status_a _right_status_x _right_status_y _right_status_z
  _left_status_a=$1
  _right_status_x=$2
  _right_status_y=$3
  _right_status_z=$4
  ...
  tmux_append_seto "pane-border-style" "fg=${col_yellow}"

  # message infos
  tmux_append_seto "message-style" "bg=${col_bg1},fg=${col_fg1}"
  ...
  tmux_append_seto "status-right" "#[bg=${_status_right_bg},fg=${col_yellow},nobold,nounderscore,noitalics]#[bg=${col_yellow},fg=${col_fg3}] ${_right_status_x} #[bg=${col_yellow},fg=${col_bg1}]#[bg=${col_bg1},fg=${col_yellow2}]#[bg=${col_yellow2},fg=${col_fg3}]${_right_status_y} #[bg=${col_yellow2},fg=${col_yellow2},nobold,noitalics,nounderscore]"

  # current window
  local _current_window_status_format_bg=${col_bg1}
  if [[ "$_statusbar_alpha" == "true" ]]; then _current_window_status_format_bg="default"; fi
  tmux_append_setwo "window-status-current-format" "#[bg=${col_yellow2},fg=${col_bg1},nobold,noitalics,nounderscore]#[bg=${col_yellow2},fg=${col_bg2}] #I #[bg=${col_yellow2},fg=${col_fg3},bold] #W#{?window_zoomed_flag,*Z,} #{?window_end_flag,#[bg=${_current_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_yellow2},nobold,noitalics,nounderscore]"

  # default window
  local _default_window_status_format_bg=${col_bg1}
  if [[ "$_statusbar_alpha" == "true" ]]; then _default_window_status_format_bg="default"; fi
  tmux_append_setwo "window-status-format" "#[bg=${col_yellow},fg=${col_bg1},noitalics]#[bg=${col_yellow},fg=${col_aldam}] #I #[bg=${col_yellow},fg=${col_aldam}] #W #{?window_end_flag,#[bg=${_default_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_yellow},noitalics]"
}
